  ...
  module Frontend
    ...
    def page_by_locale(locale)
      I18n.with_locale(locale) do
        Page.includes(:translations).i18n.find_by!(materialized_path: spina_request_path)
      end
    end
    ...
    def render_with_template(page)
      render layout: "#{current_theme.name.parameterize.underscore}/#{page.layout_template || 'application'}",
             template: "#{current_theme.name.parameterize.underscore}/pages/#{Spina::Current.page.view_template || 'show'}"
    end
  end
end
